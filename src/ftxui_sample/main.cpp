...
// configuration step. It creates a namespace called `Explore`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Explore::cmake::project_name, Explore::cmake::project_version) };
